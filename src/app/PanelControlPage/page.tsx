...
const PanelControlPage = () => {
  return (
    <div className="h-screen grid grid-cols-3 grid-rows-5 p-2 gap-2 ">
      <Link
        href="/EvaluarPage"
        className="bg-gray-700 col-span-3 flex flex-col justify-center items-center text-2xl font-bold hover:bg-gray-600 cursor-pointer"
      >
      ...
      <Link
        ...
        className="bg-gray-700 flex flex-col justify-center items-center  font-bold hover:bg-gray-600 cursor-pointer"
      >
      ...
      <Link
        ...
        className="bg-gray-700 col-span-1  flex flex-col justify-center items-center  font-bold hover:bg-gray-600 cursor-pointer"
      >
      ...
      <Link
        ...
        className="bg-gray-700 col-span-2 flex flex-col justify-center items-center  font-bold hover:bg-gray-600 cursor-pointer"
      >
      ...
      <Link
        ...
        className="bg-gray-700 col-span-1 row-span-2 flex flex-col justify-center items-center  font-bold hover:bg-gray-600 cursor-pointer"
      >
      ...
      <Link
        ...
        className="bg-gray-700 col-span-1 flex flex-col justify-center items-center  font-bold hover:bg-gray-600 cursor-pointer p-4"
      >
