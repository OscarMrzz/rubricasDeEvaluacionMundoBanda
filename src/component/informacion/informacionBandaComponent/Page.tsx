...
const InformacionBandaComponent = ({ Banda, onClose, onRefresh,openFormEditar,urlLogoBanda }: Props) => {
    ...
    return ( 
        <div>
            ...
            <div className='flex px-10 pt-4 justify-between'>
                <div className=' '>
                    <div className='w-25 aspect-square  object-cover'>
                        <img src={urlLogoBanda} alt="Logo Banda" className='object-cover' />
                    </div>
            ...
            <div className='w-full border-t-2 border-gray-400 flex h-full p-4'>
                ...
                <p className='text-gray-200'><span className='font-bold'>Alias:</span> {Banda.AliasBanda}</p>
                <p className='text-gray-200'><span className='font-bold'>Categoria:</span> {Banda.categorias.nombreCategoria}</p>
                <p className='text-gray-200'><span className='font-bold'>Región:</span> {Banda.regiones.nombreRegion}</p>
                    </div> 
                    <div className='w-full h-full p-4'>

                <p className='text-gray-200'><span className='font-bold'>Posicion:</span> {}</p>
                <p className='text-gray-200'><span className='font-bold'>Puntos:</span> {}</p>
                <p className='text-gray-200'><span className='font-bold'>Promedio:</span> {}</p>
